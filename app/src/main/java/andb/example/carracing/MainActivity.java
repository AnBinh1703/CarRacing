...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView car1Speed;
    private TextView car2Speed;
    private TextView car3Speed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        car1Speed = findViewById(R.id.car1m);
        car2Speed= findViewById(R.id.car2m);
        car3Speed= findViewById(R.id.car3m);
